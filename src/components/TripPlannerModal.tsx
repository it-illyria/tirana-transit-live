...
const TripPlannerModal = ({ open, onClose }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-end sm:items-center justify-center animate-in fade-in duration-200">
      ...
      <div className="relative bg-card rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[85vh] overflow-y-auto shadow-float animate-in slide-in-from-bottom duration-300">
        {/* Header */}
                        ...
                        <div key={j} className="flex items-center gap-2 text-xs">
                          {step.type === "board" && (
                            <>
                              ...
                              <span
                                className="px-1.5 py-0.5 rounded font-bold text-primary-foreground"
                                style={{ backgroundColor: step.route?.route_color, fontSize: 10 }}
                              >
